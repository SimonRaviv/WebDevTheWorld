...
namespace TheWorld.Models
{
	public class WorldContextSeedData
	{
		...
		public WorldContextSeedData(WorldContext contex)
		{
			_context = contex;
		}
		...
		public async Task EnsureSeedData()
		{
			if (!_context.Trips.Any())
			{
				...
				_context.Trips.Add(us_trip);
				_context.Stops.AddRange(us_trip.Stops);

				var world_trip = new Trip()
				{
					DateCreated = DateTime.UtcNow,
					Name = "World trip",
					UserName = "", //TODO: add user name.
				...
				_context.Trips.Add(world_trip);
				_context.Stops.AddRange(world_trip.Stops);
